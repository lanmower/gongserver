 ...
 */
angular.module('gong.login').service('login', ['$q', '$mdDialog', 'googleApi', 'clientId', 'scope', function ($q, $mdDialog, googleApi, clientId, scope) {
  ...
  */
  ...
  this.checkAuth = function(user) {
    ...
    var ret = executeRequest(request);
    return ret;
  };
