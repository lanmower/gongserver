 ...
 * limitations under the License.
 */
angular.module("gong.page",[]).service("page",["$http","$mdDialog",function(e,t){var n=this.data={};this.setWidgets=function(e){n.widgets=e},this.setTitle=function(e){n.title=e},this.removeWidget=function(e){widgets.splice(e,1)},this.editPage=function(e){this.data.edit=e},this.addWidget=function(e){n.widgets.push(e)},this.getData=function(e){return e&&this.load(e),this.data},self=this,this.load=function(t){e.get(t).then(function(e){angular.copy(e.data.data,self.data)})},this.save=function(t){var i=angular.copy(n);delete i.edit;var o=this;e.post(t,{data:i}).then(function(e){o.data.edit=!1})},this.showEdit=function(e){n.widgets[e].edit=!0}}]),/*
 * Copyright 2015 Almagest Fraternite All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
angular.module("gong.page").controller("PageController",["$mdDialog","$rootScope","$scope","$routeParams","page",function(e,t,n,i,o){n.data=o.getData("http://advanced/"+i.fileId),this.edit=function(e){var t=n.data.widgets[e],i=angular.copy(t);t.copy=i,t.edit=!0},this.addWidget=function(e,t){n.data.widgets.splice(t,0,{edit:!0,"new":!0})},this.editPage=function(e){1==e?n.data.copy=angular.copy(o.getData()):angular.copy(n.data.copy,n.data),o.editPage(e)},this.savePage=function(){delete n.data.copy,o.save("http://advanced/site/save")},this.save=function(t){delete n.data.widgets[t].copy,delete n.data.widgets[t]["new"],n.data.widgets[t].edit=!1,e.hide()},this.remove=function(e){n.data.widgets.splice(e,1)},this.moveUp=function(e,t){n.data.widgets.splice(t+1,0,n.data.widgets.splice(t,1)[0])},this.moveDown=function(e,t){n.data.widgets.splice(t-1,0,n.data.widgets.splice(t,1)[0])},this.cancel=function(e){if(1==n.data.widgets[e]["new"])n.data.widgets.splice(e,1);else{var t=n.data.widgets[e];angular.copy(t.copy,n.data.widgets[e]),delete t.copy}}}]);/*
 * Copyright 2015 Almagest Fraternite All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
