...
{
    public $modelClass = 'm2m\models\Post';
    ...
    public function behaviors()
    {
        ...
        $ret['corsFilter'] = [
            ...
            'cors' => [
                ...
                // Allow the X-Pagination-Current-Post header to be exposed to the browser.
                'Access-Control-Expose-Headers' => ['X-Pagination-Current-Post'],
            ],
